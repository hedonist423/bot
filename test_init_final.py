...
async def on_message(message):
	...
	if message.content.startswith('!보스명'):
		await client.send_message(channel, '폭적호, 폭백호, 적호왕, 백호왕, 국내깹방, 부여깹방, 국내인형, 부여인형, 국내세작, 부여세작', tts=True)
	...
	if message.content.startswith('!재부팅'):
		client.logout()
		client.run(token)
